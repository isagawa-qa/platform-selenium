...
function activate(context) {
    ...
    // Help
    context.subscriptions.push(vscode.commands.registerCommand('platformSelenium.help', () => showHelpQuickPick()));
}
function showHelpQuickPick() {
...
class MissionControlPanel {
    ...
    constructor(panel, workspaceRoot) {
        ...
        const qaWatcher = vscode.workspace.createFileSystemWatcher(new vscode.RelativePattern(workspaceRoot, 'tests/_state/workflow_state.json'));
